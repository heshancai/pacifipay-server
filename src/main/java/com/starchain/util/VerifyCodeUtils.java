...
public class VerifyCodeUtils
{
    ...
    public static final String VERIFY_NUMS = "0123456789";
    public static final String VERIFY_LETTER = "ABCDEFGHJKLMNPQRSTUVWXYZ";
    ...
    public static String generateVerifyLetter(int verifySize)
    {
        return generateVerifyCode(verifySize, VERIFY_LETTER);
    }

    public static String generateVerifyNum(int verifySize)
    {
        return generateVerifyCode(verifySize, VERIFY_NUMS);
    }
